"""
MoTZ Ecosystem Tracker - FastAPI Backend
Version 1.0 - Raw Data Pass-Through with 24-Hour Caching
Author: DeFi Jo$h
"""
...
class Config:
    def __init__(self):
        ...
        # MoTZ Dune query IDs
        self.dune_queries = {
            'motz_overview': 6151943,
            'daily_secondary_sales': 6152176,
            'current_stats': 6152608,
            'daily_user_activity': 6154760,
            'daily_transfer_transactions': 6155052,
        ...
        if not self.dune_api_key:
            logger.warning("Dune API key not found. Functionality will be limited.")
...
class CacheManager:
    def __init__(self):
        self.cache_dir = "motz_data_cache"
    ...
    def get_metadata_for_key(self, key: str, query_id: int, row_count: int = 0) -> DataMetadata:
...
async def lifespan(app: FastAPI):
    # Startup
    logger.info("Starting MoTZ Ecosystem Tracker API v1.0")
...
# FastAPI app
app = FastAPI(
    title="MoTZ Ecosystem Tracker API",
    description="Direct pass-through API for MoTZ blockchain data with 24-hour caching",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan
...
async def root(request: Request):
    ...
    return {
        ...
        "endpoints": {
            "dune_queries": {
                "motz_overview": "/api/raw/dune/motz_overview",
                "daily_secondary_sales": "/api/raw/dune/daily_secondary_sales",
                "current_stats": "/api/raw/dune/current_stats",
                "daily_user_activity": "/api/raw/dune/daily_user_activity",
                "daily_transfer_transactions": "/api/raw/dune/daily_transfer_transactions",
